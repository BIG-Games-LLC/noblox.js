 ...
 * @category Game
 * @alias getUniversePayoutHistory
 ...
 * @returns {Promise<UniversePayoutHistoryData[]>}
 */

function getUniversePayoutHistory (universeId, startDate, endDate, jar) {
...
exports.func = function ({ universeId, startDate, endDate, jar }) {
  ...
  return getUniversePayoutHistory(universeId, startDate, endDate, jar)
}
